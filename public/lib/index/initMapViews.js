...
function initMapViews(path,cb,ejs,ecss,config,libPath) {
    const {
    ...
    const injFiles = [
        ...
        ...(noMap ? [] : [
            ...
            libPath + 'CesiumSeal/setBaseView.js',
            libPath + 'CesiumSeal/TimeLine.js',
            libPath + 'CesiumSeal/utils.js',
            libPath + 'CesiumSeal/mapHandle.js',
            ...
            ].map(_ => libPath + "CesiumSeal/MarkerAndGraphicManager/" + _)),
        ]).map(_ => path + _), // map js
        ...[

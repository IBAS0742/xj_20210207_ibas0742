class TimeLine {
    ...
    constructor(viewer) {
        ...
        this.startTimeMill = null;//new Date(startTime).getTime();
        this.url = null; //url;
        this.parameters = {}; //parameters;
        this.parametersFromTime = null; //parametersFromTime;
        this.options = {
            alpha: 0.5,
            speed: 3600 * 24 * 1000
        };
    ...
    // startTime, endTime, url, parameters, parametersFromTime, options

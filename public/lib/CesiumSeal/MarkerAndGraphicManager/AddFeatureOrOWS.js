class AddFeatureOrOWS {
    ...
    // }
    // filterProp 会将要素中的 properties 信息作为参数传入，如何需要返回一个对象结构和 properties 一样
    //      返回的对象会作为要素的信息进行展示
    addPolygonShpGetInfo(feature,filterProp) {
        ...
        let id = this.MarkManager.createSelfControlPopDom(Cesium.Cartesian3.fromDegrees(center.lng, center.lat, 0),filterProp(feature.properties));

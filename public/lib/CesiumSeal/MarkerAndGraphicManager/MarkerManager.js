...
class MarkerManager {
    constructor(viewer, markerOptions = CesiumBillboard.defaultStyle,
        ...
        this.markerOffset = {MarkOffsetX:offset.x||0,MarkOffsetY:offset.y||0};
    }
    ...
    _reCalcDivPosition(ele,position,xOffset,yOffset) {
        ...
        h += 11;
        ele.style.left = this.markerOffset.MarkOffsetX + pos.x - 100 + (xOffset || 0) + "px";
        ele.style.top = this.markerOffset.MarkOffsetY + pos.y - h + (yOffset || 0) + "px";

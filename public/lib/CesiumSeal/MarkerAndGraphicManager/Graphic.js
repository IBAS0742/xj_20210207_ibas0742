...
class CesiumBillboard extends BaseGraphic {
    ...
    constructor(viewer, options, labelOption = CesiumBillboard.defaultLabelStyle) {
        ...
        this.options = {
            ...
            point: CesiumBillboard.defaultPointStyle,
            //billboard: options,
            label: labelOption,
        }
...
class CesiumPolyline extends BaseGraphic {
    ...
    constructor(viewer, options = CesiumPolyline.defaultStyle) {
        ...
        if (options instanceof Cesium.Entity) {
            this.options = options;
            this.options.gvid = this._gvid;
            this.options.gvtype = this._gvtype;
            this.options.gvname = this._name;
        } else {
            this.options = {
                gvname: this._name,
                gvid: this._gvid,
...
// https://cesium.com/docs/cesiumjs-ref-doc/PolygonGraphics.html?classFilter=polygongra
class CesiumPolygon extends BaseGraphic {
    ...
    constructor(viewer, options = CesiumPolygon.defaultStyle) {
        ...
        if (options instanceof Cesium.Entity) {
            this.options = options;
            options.gvid = this.gvid;
            options.gvtype = this.gvtype;
        } else {
            this.options = {
                gvid: this.gvid,
                gvtype: this.gvtype,
     ...
     */
    static defaultStyle = {
        material: new Cesium.Color.fromCssColorString('rgba(211, 227, 244,0.3)'),
        outline: true,
        outlineColor: new Cesium.Color.fromCssColorString('rgb(254, 135, 3)'),
        outlineWidth: 2,
    ...
    static fromDegrees(viewer, positions, properties = {}) {
        ...
        let options = CesiumPolygon.defaultStyle;

<template>
    <ModelPage title="蒸散发" map-rate="0.7">
        <div slot="left">
            <single-selection title="区域" :selections="types" @select="changeType"
                ...
                <div>
                    <div style="float:left;">
                        ...
                        <table cellspacing="0" cellpadding="1" border="1">
                            ...
                            <tbody style="background-color: #DEE6E8;" id="et_tbody"></tbody>
                        </table>
                    </div>
                    <div :style="echartStyle" id="et_echart"></div>
                </div>
            </div>
        </div>
    </ModelPage>
...
<script>
    ...
    import { requestEDay } from "./request";
    import { ZhengSanFaUtils } from "./utils";
    ...
    export default {
        ...
        data() {
            return {
                currentSelectInd: 0,
                types: [
                    {value: "咸海流域",key:"a",selected: false },
                ],
        ...
        methods:{
            changeType(type,ind) {
                ...
                if (this.types[ind].selected) {
                    ...
                    mapApis.showImageLegend(`${window.allUrls.base}/table/image/ET.jpg`);
